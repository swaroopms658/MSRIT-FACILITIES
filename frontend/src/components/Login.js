...
const styles = {
  container: { maxWidth: "400px", margin: "3rem auto", textAlign: "center", fontFamily: "Arial, sans-serif" },
  form: { display: "flex", flexDirection: "column", gap: "1rem" },
  input: { padding: "10px", fontSize: "16px" },
  button: { padding: "10px", backgroundColor: "#007bff", color: "white", border: "none", cursor: "pointer", fontSize: "16px" },
  error: { color: "red", marginTop: "1rem", textAlign: "left", whiteSpace: "pre-wrap" }
};
