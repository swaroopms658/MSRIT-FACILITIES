...
function BookingForm() {
  ...
  const fetchCurrentBooking = async () => {
    try {
      setLoading(true);
      const response = await axios.get("https://configuration-corps-flower-screensaver.trycloudflare.com/api/booking/me", {
    ...
    try {
      ...
      for (const facility of facilities) {
        const response = await axios.get(
          `https://configuration-corps-flower-screensaver.trycloudflare.com/api/booking/booked-slots?facility=${encodeURIComponent(
            facility
          )}`,
          {
            headers: { Authorization: `Bearer ${token}` },
  ...
  const handleBooking = async () => {
    ...
    try {
      ...
      const response = await fetch("https://configuration-corps-flower-screensaver.trycloudflare.com/api/booking", {
        method: "POST",
        headers: {
  ...
  const handleCancel = async () => {
    try {
      setLoading(true);
      await axios.delete("https://configuration-corps-flower-screensaver.trycloudflare.com/api/booking/cancel", {
        headers: { Authorization: `Bearer ${token}` },
      });
